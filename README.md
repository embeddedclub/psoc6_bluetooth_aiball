# EdgeImpulse example of AI Ball using Infineon PSoC 6
...
This examples come with a ML trained model that provides detecton of the actions `bounce` and `spin`. The preloaded Machine Learning model can be easily replaced with a different trained model from the [EdgeImpulse](https://edgeimpulse.com) Online Studio.
